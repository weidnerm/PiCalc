...
#define GETSTRING_TESTS
#define SETSTRING_TESTS
#define SAME_SIGN_ADD_TESTS
#define DIFF_SIGN_ADD_TESTS
#define SUBTRACT_TESTS
...
BigIntFactory * getFactory()
{
    ...
    switch(suiteNum)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            returnVal = new BigIntFactory31Bit;
            break;
        case 3:
            returnVal = new BigIntFactory32Bit;
            break;
        default:
            break;
...
#endif // GETSTRING_TESTS

#ifdef SETSTRING_TESTS
...
TEST(TwoValueTestGroup, speedTestDivide)
{
    ...
    STRCMP_EQUAL("-999999999999999999999999999999999999999999999999999999999999999999999999",result);
    STRCMP_EQUAL("-999999999999999999999999999999999999999999999999999999999999999999999999",result2); // make sure that B didnt change
}
#endif // DIVIDE_SPEED_TESTS
...
#endif // MULTIPLY_SPEED_TESTS

#ifdef MULTIPLY_TESTS
...
TEST(PiCalculatorTestGroup, calc_Pi_digits_400)
{
    myPiCalculator->calc_Pi_digits(myBigIntBaseA, 400);
    checkAndCleanup("", myBigIntBaseA);
}
...
//TEST(PiCalculatorTestGroup, calc_Pi_digits_5000)
//{
//    myPiCalculator->calc_Pi_digits(myBigIntBaseA, 10000);
//    checkAndCleanup("", myBigIntBaseA);
//}
